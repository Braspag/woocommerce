...
var BP = (function () {
  ...
  function l() {
      var e = d(),
          r = { TST: "https://songbirdstag.cardinalcommerce.com/edge/v1/songbird.js", SDB: "https://songbirdstag.cardinalcommerce.com/edge/v1/songbird.js", PRD: "https://songbird.cardinalcommerce.com/edge/v1/songbird.js" };
      return r[e];
  }
  function m() {
  ...
  function _(e) {
      var r = d(),
          n = { TST: "https://localhost:44351", SDB: "https://mpisandbox.braspag.com.br", PRD: "https://mpi.braspag.com.br" };
      return n[r] + e;
  }
  function b(e, r) {
  ...
  function C(e, r) {
      (X = r),
          ...
          h("[MPI]", "Token =", e),
          h("[MPI]", "ReferenceId =", X),
          Cardinal.configure({ timeout: "8000", maxRequestRetries: "10", logging: { level: f() } }),
                  ...
                  case "ERROR":
                      (U.Number = e.ErrorNumber),
                          ...
                          e.Payment && e.Payment.ProcessorTransactionId
                              ? S(e.Payment.ProcessorTransactionId)
                              : D("onError", { Xid: null, Eci: null, ReturnCode: U.HasError() ? U.Number : "MPI901", ReturnMessage: U.HasError() ? U.Description : "Unexpected error", ReferenceId: null });
                      break;
                  default:
                      (U.Number = e.ErrorNumber),
                          (U.Description = e.ErrorDescription),
                          "Success" === e.ErrorDescription && e.Payment && e.Payment.ProcessorTransactionId
                              ? S(e.Payment.ProcessorTransactionId)
                              : D("onError", { Xid: null, Eci: null, ReturnCode: U.HasError() ? U.Number : "MPI902", ReturnMessage: U.HasError() ? U.Description : "Unexpected authentication response", ReferenceId: null });
              }
          });
  }
  function v(e, n, i) {
      ...
      (o.onreadystatechange = function () {
          if (4 === this.readyState)
              if (200 === this.status) {
                  ...
                  D("onError", { Xid: null, Eci: null, ReturnCode: "MPI900", ReturnMessage: "An error has occurred (" + this.status + ")" + r, ReferenceId: null });
              }
      }),
          o.open("POST", _(e)),
              ...
              v("/v2/3ds/enroll", c(), function (e) {
                  ...
                  switch (e.Status) {
                      ...
                      case "AUTHENTICATION_CHECK_NEEDED":
                          ...
                          break;
                      case "NOT_ENROLLED":
                          D("onUnenrolled", { Xid: r.Xid, Eci: r.Eci, Version: k, ReferenceId: r.DirectoryServerTransactionId });
                          break;
                      case "FAILED":
                          D("onFailure", { Xid: r.Xid, Eci: r.Eci || r.EciRaw, Version: k, ReferenceId: r.DirectoryServerTransactionId });
                          break;
                      case "UNSUPPORTED_BRAND":
                          D("onUnsupportedBrand", { Xid: null, Eci: null, ReturnCode: e.ReturnCode, ReturnMessage: e.ReturnMessage, ReferenceId: null });
                          break;
                      default:
                          D("onError", { Xid: null, Eci: null, ReturnCode: e.ReturnCode, ReturnMessage: e.ReturnMessage, ReferenceId: null });
                  }
              });
      }
  }
  ...
  function R(e) {
      ...
      var r = c(),
          n = {
              OrderDetails: { TransactionId: e, OrderNumber: r.ordernumber, CurrencyCode: P(r, "currency"), OrderChannel: r.transactionmode || "S" },
              Consumer: {
                  Account: { AccountNumber: r.cardnumber, ExpirationMonth: r.cardexpirationmonth, ExpirationYear: r.cardexpirationyear },
                  Email1: P(r, "shiptoemail"),
                  Email2: P(r, "billtoemail"),
                  ShippingAddress: { FullName: null, Address1: null, Address2: null, City: null, State: null, PostalCode: null, CountryCode: null, Phone1: null },
                  BillingAddress: {
      ...
      if (r.cart)
          for (var t = 0; t < r.cart.length; t++) n.Cart.push({ Name: P(r.cart[t], "name"), Description: P(r.cart[t], "description"), SKU: P(r.cart[t], "sku"), Quantity: P(r.cart[t], "quantity"), Price: P(r.cart[t], "unitprice") });
      return h("[MPI] Order object =", n), n;
  }
  function A(e) {
      var n = r("bpmpi_auth_suppresschallenge");
      if ((h("[MPI] Suppression enabled = " + n), "true" === n))
          return h("[MPI]", "Challenge supressed..."), void D("onChallengeSuppression", { Xid: null, Eci: null, ReturnCode: "MPI601", ReturnMessage: "Challenge suppressed", ReferenceId: null });
  ...
  function w(e) {
      switch ((h("[MPI]", "Authentication result =", e), e.Status)) {
          case "AUTHENTICATED":
              D("onSuccess", { Cavv: e.Cavv, Xid: e.Xid, Eci: e.Eci, Version: e.Version, ReferenceId: e.DirectoryServerTransactionId });
              break;
          case "UNAVAILABLE":
              D("onUnenrolled", { Cavv: e.Cavv, Xid: e.Xid, Eci: e.Eci, Version: e.Version, ReferenceId: e.DirectoryServerTransactionId });
              break;
          case "FAILED":
              D("onFailure", { Xid: e.Xid, Eci: e.Eci || e.EciRaw, Version: e.Version, ReferenceId: e.DirectoryServerTransactionId });
              break;
          case "ERROR_OCCURRED":
              D("onError", { Xid: e.Xid, Eci: e.Eci || e.EciRaw, ReturnCode: e.ReturnCode, ReturnMessage: e.ReturnMessage, ReferenceId: e.DirectoryServerTransactionId });
              break;
          default:
              D("onError", { Xid: e.Xid, Eci: e.Eci || e.EciRaw, ReturnCode: U.HasError() ? U.Number : e.ReturnCode, ReturnMessage: U.HasError() ? U.Description : e.ReturnMessage, ReferenceId: e.DirectoryServerTransactionId });
      }
  }
  function S(e) {
      var r = c();
